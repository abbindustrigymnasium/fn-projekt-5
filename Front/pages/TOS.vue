<template>
    ...
    <div class="flex flex-col flex justify-center">
        <h1 class="text-5xl">Terms Of Service</h1>
        <p class="text-xl">Welcome to www.lorem-ipsum.info. This site is provided as a service to our visitors and may be used for informational purposes only.<br> Because the Terms and Conditions contain legal obligations, please read them carefully.</p>
    </div>
        <p>1. YOUR AGREEMENT
